...
fn specta_builder() -> tauri_specta::Builder<tauri::Wry> {
    tauri_specta::Builder::<tauri::Wry>::new()
        .commands(tauri_specta::collect_commands![
            ...
            commands::openspec::openspec_archived_changes,
            commands::openspec::openspec_get_archived_change,
            commands::openspec::openspec_read_archived_file,
