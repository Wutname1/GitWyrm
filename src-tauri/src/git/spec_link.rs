...
fn infer_link(repo_path: &str, branch: &str, base: Option<&str>) -> Result<Option<String>, AppError> {
...
pub fn resolve(repo_path: &str, branch: &str, base: Option<&str>) -> Result<Option<SpecLink>, AppError> {
