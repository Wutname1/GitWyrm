...
export function GenerateCommitsDialog({
  ...
  useEffect(() => {
    ...
    const unlisten = listen<AiCommitProgressPayload>(
      "ai-commit-progress",
      (event) => {
    ...
    <Dialog open={open} onOpenChange={changeOpen}>
      ...
      >
        <DialogHeader className="border-b border-border px-5 pb-4 pt-5">
          ...
          <DialogDescription
            id="generate-commits-description"
            className="pl-[42px] text-xs"
          >
            {created
        ...
        {created ? (
          ...
          <div className="grid gap-5 px-5 py-5">
            <section>
              ...
              <div className="flex items-center gap-3 rounded-lg border border-border bg-panel2 p-2.5">
                ...
                <div className="min-w-0 flex-1 text-center">
                  <div className="font-wordmark text-xl text-accent-text">
                    {count}
                  </div>
                ...
                <Button
                  ...
                  onClick={() =>
                    setCount((value) => Math.min(maxCommits, value + 1))
                  }
            ...
            <section>
              <label
                htmlFor="commit-split-instructions"
