...
export const SETTINGS_INDEX: SettingsIndexEntry[] = [
  ...
  },
  {
    ...
    section: 'general',
    label: 'Code folders',
    hint: 'Folders searched for projects to open. The starred one is your main folder.',
    keywords: [
      'projects',
      'directory',
      'path',
  ...
  // ------------------------------------------------------------------ logs
  {
    ...
    hint: 'Send us what went wrong, with your log and a screenshot attached.',
    keywords: [
      'bug',
      'bug report',
      'report',
  ...
  },
  {
    ...
    section: 'logs',
    label: 'Send feedback',
    hint: 'Share an idea or tell us what could work better. No log unless you ask.',
    keywords: [
      'feedback',
      'idea',
      'suggestion',
