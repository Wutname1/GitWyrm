...
const SUBTITLES: Partial<Record<SettingsSection, string>> = {
  ...
  behavior: 'Choose what happens at startup, in the background, and when work is discarded.',
  repository: 'These settings apply only to the repository open in the active tab.',
  repositoryTags: 'Override tag behavior for the repository open in the active tab.',
  tags: 'Choose the tag behavior new repositories start with.',
  profiles: 'Keep work and personal commit details separate.',
  ai: 'Choose the model that helps write commit messages and summaries.',
  integrations: 'Connect the sites where your code, reviews, and issues live.',
  openspec: 'Choose how GitWyrm works with the openspec folder in your projects.',
  security: 'Manage secure connections, commit proof, and trusted programs.',
  ...
  about: 'See your version, choose how updates arrive, or restore app settings.',
}
